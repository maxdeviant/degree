...
public class TestPrograms {
    ...
    public static Stm prog1 = new AssignStm("a", new NumExp(10));

    public static Stm prog2 = new PrintStm(new LastExpList(new NumExp(5)));
