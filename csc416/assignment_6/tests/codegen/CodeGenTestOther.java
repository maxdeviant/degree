...
public class CodeGenTestOther {
    ...
    public CodeGenTestOther(File testProgram) {
    ...
    public static Collection ramPrograms() {
        ...
        return Arrays.asList(new Object[] {
            new File(System.getProperty("CODEGEN_DIR") + File.separator + "3-other" + File.separator + "SideEffectTest.ram15")
        });
