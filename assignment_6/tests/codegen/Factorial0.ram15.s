...
Fac.ComputeFac:
	...
	lw $v0, -8($fp)      # load offset of parameter syntaxtree.IdentifierExp@5d383338 into $v0
	...
	beqz $v0, False6              # if expr == false, jump to False6
	li $v0, 1        # load literal 1 into $v0
	subu $sp, $sp, 4       # stack push...
	sw $v0, 0($sp)         # push v0 onto stack
	...
	j DoneIf6               # jump past false
False6:
	lw $v0, -8($fp)      # load offset of parameter syntaxtree.IdentifierExp@4bbdd76c into $v0
	subu $sp, $sp, 4       # stack push...
	sw $v0, 0($sp)         # push v0 onto stack
	#caller Fac.ComputeFac preparing for function call
	sw $ra, -20($fp)       # save return address
	lw $v0, -8($fp)      # load offset of parameter syntaxtree.IdentifierExp@209e715b into $v0
	subu $sp, $sp, 4       # stack push...
	sw $v0, 0($sp)         # push v0 onto stack
	li $v0, 1        # load literal 1 into $v0
	lw $v1, 0($sp)         # pop stack value into $v1
	...
	sw $v1, 0($v0)         # assign value in $v1 into addr in $v0
DoneIf6:
	lw $v0, -24($fp)      # load offset of local variable syntaxtree.IdentifierExp@3e8c80f5 into $v0
